...
public class Email : IEmail {
    ...
    public bool Enviar( string email, string subject, string message ) { // Envia o email
        try {
            ...
            MailMessage mail =
                new MailMessage() { // Cria o objeto de email
                    ...
                    Body = message, // Mensagem do email
                    IsBodyHtml = true, // Define que a mensagem é HTML, para poder usar tags HTML e deixar o email mais bonito
